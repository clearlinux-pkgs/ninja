...
Source0  : https://github.com/ninja-build/ninja/archive/v1.12.0/ninja-1.12.0.tar.gz
...
%prep
%setup -q -n ninja-1.12.0
cd %{_builddir}/ninja-1.12.0
pushd ..
cp -a ninja-1.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713199245
