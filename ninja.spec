...
Source0  : https://github.com/ninja-build/ninja/archive/v1.11.0/ninja-1.11.0.tar.gz
...
%prep
%setup -q -n ninja-1.11.0
cd %{_builddir}/ninja-1.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652902983
...
cp %{_builddir}/ninja-1.11.0/COPYING %{buildroot}/usr/share/package-licenses/ninja/b7a11257fc8046a2f00f1a685da1f2bca2a3ba50
%make_install ||:
